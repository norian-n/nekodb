...
const std::string linksSetsStorageName      ("egLinksSetsMetainfo");
const std::string linksSetFieldName         ("egLinksSetName");
const std::string linksBPFieldName          ("egLinkBlueprintName");
